...
EXPERIMENT_NAME_T5_CRF = "t5+crf-experiment-1"
EXPERIMENT_RESULTS_DIR_T5_CRF = RESULTS_DIR_T5_CRF + EXPERIMENT_NAME_T5_CRF

LR_T5_CRF = 2e-5
TRAIN_BATCH_SIZE_T5_CRF = 16
EVAL_BATCH_SIZE_T5_CRF = 16
NUM_TRAIN_EPOCHS_T5_CRF = 5
WEIGHT_DECAY_T5_CRF = 0.01
EVAL_STEPS_T5_CRF = 200
SAVE_STEPS_T5_CRF = 200
GRADIENT_ACCUMULATION_STEPS_T5_CRF = 1

LOGGING_STEPS_T5_CRF = 100
