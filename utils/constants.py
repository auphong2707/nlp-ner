...
EXPERIMENT_NAME_BERT_CLS_FOCAL = "bert-cls-focal-experiment-2"
...
NUM_TRAIN_EPOCHS_BERT_CLS_FOCAL = 35
WEIGHT_DECAY_BERT_CLS_FOCAL = 0.01
EVAL_STEPS_BERT_CLS_FOCAL = 200
SAVE_STEPS_BERT_CLS_FOCAL = 200
GRADIENT_ACCUMULATION_STEPS_BERT_CLS_FOCAL = 2

LOGGING_STEPS_BERT_CLS_FOCAL = 20
# --------------------------------------------------------------------------------------------
...
EXPERIMENT_NAME_T5_CLS_FOCAL = "t5-cls-focal-experiment-veil-2"
EXPERIMENT_RESULTS_DIR_T5_CLS_FOCAL = RESULTS_DIR_T5_CLS_FOCAL + EXPERIMENT_NAME_T5_CLS_FOCAL

LR_T5_CLS_FOCAL = 1e-6            
TRAIN_BATCH_SIZE_T5_CLS_FOCAL = 128   
EVAL_BATCH_SIZE_T5_CLS_FOCAL = 128  
NUM_TRAIN_EPOCHS_T5_CLS_FOCAL = 50  
WEIGHT_DECAY_T5_CLS_FOCAL = 0.001 
EVAL_STEPS_T5_CLS_FOCAL = 200
SAVE_STEPS_T5_CLS_FOCAL = 200        
GRADIENT_ACCUMULATION_STEPS_T5_CLS_FOCAL = 16
MAX_GRAD_NORM_T5_CLS_FOCAL = 100

LOGGING_STEPS_T5_CLS_FOCAL = 5
# --------------------------------------------------------------------------------------------
...
EXPERIMENT_NAME_ROBERTA_CLS_FOCAL = "roberta-cls-focal-experiment-1"
EXPERIMENT_RESULTS_DIR_ROBERTA_CLS_FOCAL = RESULTS_DIR_ROBERTA_CLS_FOCAL + EXPERIMENT_NAME_ROBERTA_CLS_FOCAL

LR_ROBERTA_CLS_FOCAL = 1e-4
TRAIN_BATCH_SIZE_ROBERTA_CLS_FOCAL = 64
EVAL_BATCH_SIZE_ROBERTA_CLS_FOCAL = 64
NUM_TRAIN_EPOCHS_ROBERTA_CLS_FOCAL = 35
WEIGHT_DECAY_ROBERTA_CLS_FOCAL = 0.01
EVAL_STEPS_ROBERTA_CLS_FOCAL = 200
SAVE_STEPS_ROBERTA_CLS_FOCAL = 200
GRADIENT_ACCUMULATION_STEPS_ROBERTA_CLS_FOCAL = 2

LOGGING_STEPS_ROBERTA_CLS_FOCAL = 20
# --------------------------------------------------------------------------------------------


# [7. BERT CRF HYPERPARAMETERS]
SCALE_STEP_BERT_CRF = 1
...
EVAL_STEPS_BERT_CRF = 373*SCALE_STEP_BERT_CRF
SAVE_STEPS_BERT_CRF = 373*SCALE_STEP_BERT_CRF
GRADIENT_ACCUMULATION_STEPS_BERT_CRF = 1

LOGGING_STEPS_BERT_CRF = 373*SCALE_STEP_BERT_CRF

EXPERIMENT_NAME_BERT_CRF = f"bert+crf-experiment-1-lr-{LR_BERT_CRF}-decay-{WEIGHT_DECAY_BERT_CRF}-eval_step-{EVAL_STEPS_BERT_CRF}-batch-{TRAIN_BATCH_SIZE_BERT_CRF}"
EXPERIMENT_RESULTS_DIR_BERT_CRF = RESULTS_DIR_BERT_CRF + EXPERIMENT_NAME_BERT_CRF
# --------------------------------------------------------------------------------------------


# [8. ROBERTA CRF HYPERPARAMETERS]
SCALE_STEP_ROBERTA_CRF = 1
...
EVAL_STEPS_ROBERTA_CRF = 373*SCALE_STEP_ROBERTA_CRF
SAVE_STEPS_ROBERTA_CRF = 373*SCALE_STEP_ROBERTA_CRF
GRADIENT_ACCUMULATION_STEPS_ROBERTA_CRF = 1

LOGGING_STEPS_ROBERTA_CRF = 373*SCALE_STEP_ROBERTA_CRF

EXPERIMENT_NAME_ROBERTA_CRF = f"roberta+crf-experiment-1-lr-{LR_ROBERTA_CRF}-decay-{WEIGHT_DECAY_ROBERTA_CRF}-eval_step-{EVAL_STEPS_ROBERTA_CRF}-batch{TRAIN_BATCH_SIZE_ROBERTA_CRF}"
...
EXPERIMENT_NAME_T5_CRF = "T5+CRF-experiment-first"
