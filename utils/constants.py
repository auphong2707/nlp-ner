...
EXPERIMENT_NAME_BERT_CRF = f"bert+crf-experiment-4"
...
LR_ROBERTA_CRF = 5e-5
TRAIN_BATCH_SIZE_ROBERTA_CRF =64
EVAL_BATCH_SIZE_ROBERTA_CRF = 64
...
GRADIENT_ACCUMULATION_STEPS_ROBERTA_CRF = 2

LOGGING_STEPS_ROBERTA_CRF = 373*SCALE_STEP_ROBERTA_CRF

EXPERIMENT_NAME_ROBERTA_CRF = f"roberta+crf-experiment-4"
