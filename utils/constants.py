...
EXPERIMENT_NAME_BERT_CRF = f"bert+crf-experiment-1-lr-{LR_BERT_CRF}-decay-{WEIGHT_DECAY_BERT_CRF}-eval_step-{EVAL_STEPS_BERT_CRF}"
...
EXPERIMENT_NAME_ROBERTA_CRF = f"roberta+crf-experiment-1-lr-{LR_ROBERTA_CRF}-decay-{WEIGHT_DECAY_ROBERTA_CRF}-eval_step-{EVAL_STEPS_ROBERTA_CRF}"
