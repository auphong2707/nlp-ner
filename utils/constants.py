...
LR_BERT_CRF = 5e-5
TRAIN_BATCH_SIZE_BERT_CRF = 32*BATCH_SACLE
EVAL_BATCH_SIZE_BERT_CRF = 32*BATCH_SACLE
NUM_TRAIN_EPOCHS_BERT_CRF = 20
WEIGHT_DECAY_BERT_CRF = 0.005
EVAL_STEPS_BERT_CRF = 373*SCALE_STEP_BERT_CRF
SAVE_STEPS_BERT_CRF = 373*SCALE_STEP_BERT_CRF
GRADIENT_ACCUMULATION_STEPS_BERT_CRF = 2

LOGGING_STEPS_BERT_CRF = 373*SCALE_STEP_BERT_CRF

EXPERIMENT_NAME_BERT_CRF = f"bert+crf-experiment-7"
...
EXPERIMENT_NAME_ROBERTA_CRF = f"roberta+crf-experiment-1"
